...
PLUGIN_CURRENT_VERSION=$(awk '/    Version/{print $NF}' lifterlms_enrollment_importer.php)
...
# - In main file
sed -i "" "s/${PLUGIN_CURRENT_VERSION}/${PLUGIN_NEXT_VERSION}/g" lifterlms_enrollment_importer.php
# - In versin file
